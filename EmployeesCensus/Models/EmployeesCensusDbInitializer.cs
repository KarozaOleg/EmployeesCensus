...
namespace EmployeesCensus.Models
{
    public class EmployeesCensusDbInitializer : DropCreateDatabaseAlways<EmployeesCensusContext>
    {
        protected override void Seed(EmployeesCensusContext db)
        {
            ...
            db.Employees.Add(new Employee { FirstName = "Михаил", LastName = "Теселки", Age = 48, Sex = Sex.Male, DepartmentId = 2 });
            db.Employees.Add(new Employee { FirstName = "Анна", LastName = "Петров", Age = 23, Sex = Sex.Female, DepartmentId = 2 });
